...
@Component({
  selector: 'app-colaborador-produtos',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './colaborador-produtos.component.html',
  styleUrl: './colaborador-produtos.component.scss'
})
export class ColaboradorProdutosComponent {
