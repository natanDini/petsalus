...
@Component({
  selector: 'app-colaborador-agendamentos',
  imports: [CommonModule],
  standalone: true,
  templateUrl: './colaborador-agendamentos.component.html',
  styleUrls: ['./colaborador-agendamentos.component.scss']
})
export class ColaboradorAgendamentosComponent implements OnInit {
  agendamentos: any[] = [];
