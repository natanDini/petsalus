...
@Component({
  selector: 'app-colaborador-servicos',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './colaborador-servicos.component.html',
  styleUrl: './colaborador-servicos.component.scss'
})
export class ColaboradorServicosComponent {
