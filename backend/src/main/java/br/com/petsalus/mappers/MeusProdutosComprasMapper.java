...
public class MeusProdutosComprasMapper {
    ...
    public MeusProdutosCompras map(ItemCompra produto) {
        ...
        return MeusProdutosCompras.builder()
                .id(produto.getId())
                ...
                .empresa(produto.getProduto().getEmpresa().getNome())
                .fotoProduto(fotoBase64)
                .build();
    }

    public static List<MeusProdutosCompras> map(List<ItemCompra> produtos) {
        return produtos.stream()
                .map(MeusProdutosComprasMapper::map)
